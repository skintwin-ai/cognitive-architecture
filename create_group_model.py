...
def main(output_path: str | None = None):
    ...
    workbook = load_existing_workbook(excel_file, ['Assumptions', 'Revenue', 'COGS', 'Operational Costs', 'SG&A'])
...
if __name__ == '__main__':
    args = parse_output_args('Create the group model sheet for the SkinTwin financial model workbook.')
    main(args.output)
